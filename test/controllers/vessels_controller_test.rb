...
class VesselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vessel" do
    assert_difference('Vessel.count') do
      post vessels_url, params: { vessel: { name: @vessel.name, type: @vessel.type, vessel_id: @vessel.vessel_id } }
    end
  ...
  test "should update vessel" do
    patch vessel_url(@vessel), params: { vessel: { name: @vessel.name, type: @vessel.type, vessel_id: @vessel.vessel_id } }
